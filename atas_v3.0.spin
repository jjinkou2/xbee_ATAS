...
PUB OledDisplay
 ...
 'LED.MoveCursor(0,0)                                     ''Position Cursor at row and column
 'LED.PutString(string("NB SSID : "),0)
 LED.dec(11,3,3)

 LED.MoveCursor(7,0)                                     ''Position Cursor at row and column
 LED.PutString(string("a uOLED-128-G2    ",10,13,"display sold at...",10,13,10,13,"www.parallax.com  "),0)
